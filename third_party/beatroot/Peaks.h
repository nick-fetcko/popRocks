...
public:
     ...
     */
    static std::size_t findPeaks(const vector<double> &data, vector<std::size_t> peaks, int width);
     ...
     */ 
    static vector<std::size_t> findPeaks(const vector<double> &data, int width,
				 double threshold) {
    ...
    static bool overThreshold(const vector<double> &data, std::size_t index, int width,
