...
{
public:
	double getFFTTime() const { return fftTime; } // Added 12Jun2025 by Nick Fetcko
    int getFFTSize() const { return fftSize; }
	double getHopTime() const { return hopTime; } // Added 12Jun2025 by Nick Fetcko
	void setHopTime(double hopTime) { // Added 02Jul2025 by Nick Fetcko
